...
export const CORE_HOST_DETECTION_INVENTORY = Object.freeze({
  ...
  cursor: ['cursor', 'cursor-agent', '/Applications/Cursor.app', '$HOME/Applications/Cursor.app', '$HOME/.cursor/mcp.json', '$HOME/.cursor/settings.json', '$HOME/.cursor/plugins/local'],
  codex: ['codex', '/Applications/Codex.app', '$HOME/Applications/Codex.app', '$HOME/.codex/config.toml', '$HOME/.codex/plugins', '$HOME/.agents/plugins/marketplace.json'],

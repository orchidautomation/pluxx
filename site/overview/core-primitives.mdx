...
Current support is target-graded, not uniform; rich metadata is currently Codex-first while other hosts expose narrower or no manifest-backed brand surfaces.

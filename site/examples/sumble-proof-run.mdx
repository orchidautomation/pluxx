...
- Bun installed
- Pluxx installed or available via `bun bin/pluxx.js`
...
```bash
bun bin/pluxx.js install --target claude-code --trust
bun bin/pluxx.js agent run taxonomy --runner codex
bun bin/pluxx.js agent run instructions --runner codex
```

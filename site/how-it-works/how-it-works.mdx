...
Every AI coding tool has its own plugin format. If you want your tool inside Claude Code, Cursor, Codex, OpenCode, and GitHub Copilot, you need to maintain separate manifests, MCP configs, hooks, rules, and install/update behaviors for each one.
...
- [Closed-Won Outbound Example](/examples/closed-won-outbound-example)

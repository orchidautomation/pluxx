...
- the shared runtime key includes dependency shape, lockfile content, the bootstrap script, OS, architecture, Node ABI, and the Pluxx runtime-store contract version; corrupted matching entries are repaired before reuse

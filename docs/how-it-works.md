...
Pluxx is published on npm as `@orchid-labs/pluxx` and the published CLI now runs on Node `>=18`.
...
- contributor workflows in this repo still use Bun for build and test scripts

...
The canonical and independently verified public release is `@orchid-labs/pluxx@0.1.40` for the PLUXX-344 hook workspace-precedence repair merged through PR #473. Immutable tag `v0.1.40` points to trusted merge `8a7152a0433a930608caca73283040c068762071`; tag-triggered Release run [31283794540](https://github.com/orchidautomation/pluxx/actions/runs/31283794540) published byte-identical npm and GitHub artifacts at SHA-256 `5e9b39c5ad0a2a2b99bf8335ae7b8e51552d7679744a2beafbd323e6b89e3ab3`. Fresh current receipts `v0.1.40-repository-validation` and `v0.1.40-fake-home-install` bind to exact release-prep commit `32019d73f046ce7b69a55bff0019e0afa948b0c0`, where `npm run release:check` passed on 2026-08-08 with 62 test files and 829 tests plus isolated packed-runtime and dry-pack verification. No current receipt claims installed-runtime or real-host behavior.

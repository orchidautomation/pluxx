...
The canonical repository release candidate is `@orchid-labs/pluxx@0.1.42` for PLUXX-348, carrying the merged PLUXX-346 strict Agent Plugins portable target, the merged PLUXX-347 overlay policy, and the merged PR #483 installer rollback repair. It is not yet tagged or published; this preparation was reconstructed from exact trusted `main` at `ff8d5abc8beb7a9e5aac363234f4ffd7646757fe` after PRs #485 and #486 merged. Current receipts `v0.1.42-repository-validation`, `v0.1.42-fake-home-install`, and `v0.1.42-portable-compatible-client-fixtures` bind to exact release-prep commit `aa13f53f938eeba67d38b22de7070dcbff57eb44`, where `npm run release:check` passed with 65 test files and 868 tests plus isolated packed-runtime and dry-pack verification. The portable fixture receipt binds both fixture copies to artifact SHA-256 `dee9383c71a53222f00f6dc72bbcee19cf451e5dde59a7c2b56c64b5cfae89fb`. The independently verified historical public release remains `@orchid-labs/pluxx@0.1.41`; immutable tag `v0.1.41` points to trusted merge `0379d2c646ad9b83fb31016d9d553ba5dea96e76`, and Release run [33254601754](https://github.com/orchidautomation/pluxx/actions/runs/33254601754) published byte-identical npm and GitHub artifacts at SHA-256 `25e0039ad63f10a79970d8028c56461f9813cbfb522088be93beba18bde6508e`. The 0.1.41 receipts are historical. No current preparation receipt claims installed-runtime, real-host behavior, or a documented Codex Agent Plugins local installation.

...
The canonical independently verified public release is `@orchid-labs/pluxx@0.1.45` / `v0.1.45`, carrying the merged portable workflow, transactional migration, and same-name Codex plugin collision work from PRs #434, #435, and #503. Immutable tag `v0.1.45` resolves to trusted main commit `e4b1e8d9ee48ffba60f6c3775133c0d15ca0dbb5`; Release run [34067859595](https://github.com/orchidautomation/pluxx/actions/runs/34067859595) published byte-identical npm and GitHub tarballs at SHA-256 `3f19bc70cc870c875283132fd20e4aede94bbcdf4ac9759366b126aed3c874dd`. npm reports integrity `sha512-zl9i3hPgK3JFZzFV/vmQk1VjIaR1b6RpWgUNNh3Re4umm/L+elVa3a6XJbyoFdsndHk0XBpjVJjsqcFdLPX3FA==`, and the published package reports `0.1.45`. Trusted release CI supplies fresh repository and native core-four fake-home proof. The 0.1.43 and earlier receipts are historical. No current receipt claims active-home installation or real-host behavior.

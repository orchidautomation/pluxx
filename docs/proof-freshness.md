...
The canonical repository release candidate is `@orchid-labs/pluxx@0.1.41` for PLUXX-345, carrying the merged Codex hook-root repair from PR #479. It is not yet tagged or published. Fresh current receipts `v0.1.41-repository-validation` and `v0.1.41-fake-home-install` bind to exact release-prep commit `e3d9cd3389673dfa6ff8f22939c287dee20866db`, where `npm run release:check` passed on 2026-08-29 with 62 test files and 832 tests plus isolated packed-runtime and dry-pack verification. The independently verified public release remains `@orchid-labs/pluxx@0.1.40`; immutable tag `v0.1.40` points to trusted merge `8a7152a0433a930608caca73283040c068762071`, and Release run [31283794540](https://github.com/orchidautomation/pluxx/actions/runs/31283794540) published byte-identical npm and GitHub artifacts at SHA-256 `5e9b39c5ad0a2a2b99bf8335ae7b8e51552d7679744a2beafbd323e6b89e3ab3`. The 0.1.40 receipts are historical while 0.1.41 proof is prepared. No current receipt claims installed-runtime or real-host behavior.
